export const en = {
  ...
  'vrPlaces.priymachenko_museum': 'Ivankiv, Primachenko museum, Kyiv region',
  'vrPlaces.rusaniv': 'Rusaniv village, Kyiv region',
  'vrPlaces.vorzel': 'Vorzel village, Kyiv region',
  'vrPlaces.irpin': 'The Central House of Culture, Irpin, Kyiv region',
  'vrPlaces.gas_station': 'Gas Station, Kyiv region',
  'vrPlaces.bucha_novus': 'Bucha city, superstore "Novus", Kyiv region',
