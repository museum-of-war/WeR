...
export const ua: Record<TranslationKey, string> = {
  ...
  'donate.walletNeeded': 'Вам потрібен Ethereum гаманець, щоб зробити внесок. Під’єднайте його за допомогою доступних провайдерів або створіть новий.',
  ...
  'donate.recipient.dronarium.donate':
      'Зробити внесок до DRONARIUM',
